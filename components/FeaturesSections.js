          ...
          <div className="col-lg-8 order-lg-1 mb-5 mb-lg-0">
            <div className="container-fluid px-5">
              <div className="row gx-5">
                ...
                <div className="col-md-6 mb-5">
                  <div className="text-center">
                    <i className="bi-stack icon-feature text-gradient d-block mb-3" />
                    <h3 className="font-alt">Flexible Pricing</h3>
                    <p className="text-muted mb-0">Only pay for the features you use.</p>
                  </div>
                </div>
              </div>
              <div className="row">
                <div className="col-md-6 mb-5 mb-md-0">
                  <div className="text-center">
                    ...
                    <h3 className="font-alt">Free Tier</h3>
                    <p className="text-muted mb-0">Start using the App, not card required!</p>
                  </div>
                </div>
                <div className="col-md-6">
                  <div className="text-center">
                    <i className="bi-patch-check icon-feature text-gradient d-block mb-3" />
                    <h3 className="font-alt">Secure</h3>
